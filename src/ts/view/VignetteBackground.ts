import {Color, FrontSide, Mesh, PlaneGeometry, RawShaderMaterial, Vector2} from "three";

/**Based on https://github.com/mattdesl/three-vignette-background */

export class VignetteBackground
{
	private _mesh: Mesh;
	...
	{
		opt = opt || {};
		const geometry = opt.geometry || new PlaneGeometry(2, 2);
